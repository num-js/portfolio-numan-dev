      ...
      >
        ...
        >
          ...
          <a
            ...
            download
            className="group/cta inline-flex items-center gap-1.5 rounded-full border border-accent-orange-soft/50 px-4 py-2 text-sm font-medium text-accent-orange-soft transition-colors duration-300 hover:bg-accent-orange/10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-orange-soft"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
